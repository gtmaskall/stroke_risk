...
just over 78% of them. In other words, to pick up 78% of stroke
victims via random sampling, we'd expect to have to sample
78% of the population.

This is not bad for a simple model with a single feature. We've
more than halved the number of people to follow up on whilst
more than doubling the hit rate.
...
individuals, or `r round(100 * sum(selected_feats_preds) / length(selected_feats_preds))`% of the population.
